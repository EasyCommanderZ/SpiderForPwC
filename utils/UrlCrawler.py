...
class UrlCrawler:
    ...
    def __init__(self):
        ...
        分别为machine learning,computer science,physics,mathematics,astronomy,statistics
        ...
        self.portalName = ["Machine Learning", "Computer Science", "Physics", "Math", "Astronomy", "Statistics"]
    ...
    def getProgress(self):
        ...
        # status line 2n = 1 indicates that this part finished, 0 for un-finished
    ...
    def get_content(self, url):
        try:
            ...
            response = requests.get(url, headers={'User-Agent': user_agent}, proxies=self.clash_proxy)
    ...
    def crawlUrlInPage(self, url, type):
        try:
            ...
            for paper in papers:
                ...
                real_url = temp_soup.find_all("a", attrs={'class': "badge"})[1]['href']
        ...
        for category in range(type, len(self.portalList)):
            ...
            while not is_end:
                ...
                if temp_urls == real_urls:
                    print(self.portalName[category] + " comes to an end, finish this part & update progress")
                    is_end = True
                    status[category * 2] = '1'
